...
### Fixed
- `opentelemetry-instrumentation-fastapi`: Fix FastAPI instrumentation tests failing in CI.
  ([#20](https://github.com/open-telemetry/opentelemetry-python-contrib/pull/20))
